        ...
        <div className="flex gap-x-3">
          <div className="lg:w-200">
            ...
            <div className="flex justify-between mb-7">
              <form className="filter flex flex-nowrap lg:w-110 overflow-x-scroll no-scrollbar">
                <input className="btn btn-square h-9" type="reset" value="All"  />
                <input
            ...
            <p className="w-fit font-bold ms-5 mb-5 ">All Items</p>
            <div className="">
